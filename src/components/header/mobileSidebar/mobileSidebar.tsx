...
function MobileSidebarComp({ openSidebar, setOpenSidebar }: { openSidebar: boolean; setOpenSidebar: (value: boolean) => void }) {
  ...
  return (
    <div className={`lg:hidden w-full h-[calc(100%-128px)] bg-main fixed z-50 top-0 transition-all ${openSidebar ? "right-0" : "-right-full"}`}>
      ...
      <main className="w-full h-[calc(100%-48px)] flex flex-col items-center justify-between gap-2.5 p-2.5">
        ...
        <div className="pr-2.5 lg:!pr-2 flex gap-2 w-full">
